...
- [📖 About the Project](#about-project)
  ...
  - [Link To Frontend ](#-link-to-front-end)
...
[React Frontend](https://github.com/abel-tefera/hello-react-front-end)
...
- On the terminal run this command git clone https://github.com/abel-tefera/Hello-Rails-Back-End.git
...
```sh
git clone https://github.com/abel-tefera/hello-rails-back-end.git
```
